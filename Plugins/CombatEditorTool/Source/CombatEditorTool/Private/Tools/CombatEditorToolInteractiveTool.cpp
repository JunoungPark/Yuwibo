...
#include "CombatEditorToolInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UCombatEditorToolInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UCombatEditorToolInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UCombatEditorToolInteractiveTool* NewTool = NewObject<UCombatEditorToolInteractiveTool>(SceneState.ToolManager);
...
void UCombatEditorToolInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UCombatEditorToolInteractiveTool::Setup()
{
	...
	Properties = NewObject<UCombatEditorToolInteractiveToolProperties>(this, "Measurement");
...
void UCombatEditorToolInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UCombatEditorToolInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UCombatEditorToolInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UCombatEditorToolInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UCombatEditorToolInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UCombatEditorToolInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UCombatEditorToolInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UCombatEditorToolInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UCombatEditorToolInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
