...
#include "CombatEditorToolInteractiveTool.generated.h"
 ...
 */
UCLASS()
class COMBATEDITORTOOL_API UCombatEditorToolInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class COMBATEDITORTOOL_API UCombatEditorToolInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UCombatEditorToolInteractiveToolProperties();
 ...
 */
UCLASS()
class COMBATEDITORTOOL_API UCombatEditorToolInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UCombatEditorToolInteractiveToolProperties> Properties;
