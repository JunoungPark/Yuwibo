...
#include "CombatEditorToolEditorMode.generated.h"
 ...
 */
UCLASS()
class UCombatEditorToolEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_CombatEditorToolEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UCombatEditorToolEditorMode();
	virtual ~UCombatEditorToolEditorMode();
